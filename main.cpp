 ...
 void frontscreen(void)
{
	...
	glEnd();
 glColor3f(255,173,0);
	output(40,90,"KEVIN BARNES(1BY20CS085)");
    output(40,78,"KEVIN MATHEW(1BY20CS086) ");
    output(40,66,"NISAR AHMED P(1BY21CS412) ");
	...
	output(40,50,"");
	glColor3f(0.2,1,1);
	drawstring(72,50,"Prof.SHANKAR R",GLUT_BITMAP_HELVETICA_18);
	glColor3f(1,0,0);
	drawstring(72,45,"Assistant Professor,Department of CSE",GLUT_BITMAP_HELVETICA_12);
	glColor3f(1,0,0);
	output(40,30,"");
	glColor3f(0.2,1,1);
	drawstring(72,30,"Prof. CHETHANA C",GLUT_BITMAP_HELVETICA_18);
	glColor3f(1,0,0);
    drawstring(72,25,"Assistant Professor,Department of CSE",GLUT_BITMAP_HELVETICA_12);
	glFlush();
